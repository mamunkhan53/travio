...
<div class="space-y-5">
    ...
    <form method="GET" class="bg-white rounded-2xl soft-shadow border border-slate-100 p-4 flex flex-wrap gap-3 items-center">
        ...
        <a href="?route=app&page=sc_visa" class="text-sm text-slate-500 hover:text-slate-700 font-bold">Reset</a>
    </form>
            ...
            <table class="w-full text-sm">
                ...
                <?php else: foreach ($visas as $v): ?>
                    <tr class="hover:bg-slate-50 transition">
                        <td class="px-4 py-3"><a href="?route=app&page=sc_students&id=<?= $v['student_id'] ?>&tab=visa" class="font-bold text-indigo-700 hover:underline"><?= xss_clean($v['student_name']) ?></a></td>
