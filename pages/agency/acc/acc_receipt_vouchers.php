...
<div class="no-print mb-4 flex gap-2">
    ...
    <a href="?route=app&page=acc_receipt_vouchers&from_date=<?= $accFrom ?>&to_date=<?= $accTo ?>" class="bg-slate-100 text-slate-700 px-5 py-2.5 rounded-xl text-sm font-bold">← Back</a>
</div>
...
<tr class="hover:bg-slate-50 transition">
    ...
    <td class="px-4 py-3">
        <a href="?route=app&page=acc_receipt_vouchers&print=<?= $v['id'] ?>" class="text-xs font-bold text-teal-600 bg-teal-50 px-2.5 py-1.5 rounded-lg hover:bg-teal-100 transition">Print</a>
