                ...
                <script>
                    function openStaffModal(action, dataStr = null) {
                        ...
                        if (action === 'add') {
                            ...
                            ['can_add_enquiry','can_edit_enquiry','can_delete_enquiry','can_add_sale','can_edit_sale','can_delete_sale','can_add_expense','can_edit_expense','can_delete_expense','can_view_reports','can_manage_customers'].forEach(p => {
